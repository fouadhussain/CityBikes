...
class JUnit_List_CityBike_Locations_USA_With_WebLink {

	@Test
	void test() {
		String countrycode ="US"; //UK Country Code
		...
		while(objectIterator.hasNext()) {
			...
			{
				System.out.println(y+" - "+p+" - LAT: "+latitude+", LONG: "+longitude+" - WebLink: "+href);
			}
